...
#module for calling private ec2 with its security group and nic to create private_ec2_1 
module "private_ec2_1" {
  source = "./private_ec2"
  private_ec2_sg_name = var.private_ec2_1_sg_name
  vpc_id = module.vpc.vpc
  subnet_id = module.priv_subnet.subnet-id
  private_ip_for_priv_ec2 = var.private_ip_for_priv_ec2_1
  private_ec2_name = var.private_ec2_1_name
  ami = var.ami
  instance_type = var.instance_type
...
#module for calling private ec2 with its security group and nic to create private_ec2_2
module "private_ec2_2" {
  source = "./private_ec2"
  private_ec2_sg_name = var.private_ec2_2_sg_name
  vpc_id = module.vpc.vpc
  subnet_id = module.priv_subnet.subnet-id
  private_ip_for_priv_ec2 = var.private_ip_for_priv_ec2_2
  private_ec2_name = var.private_ec2_2_name
  ami = var.ami
  instance_type = var.instance_type
  key_name = var.priv_key_name
...
module "application_load_balancer" {
  ...
  target_private_aws_instance_1_id = module.private_ec2_1.aws_private_ec2
  alb_tg_2_name = var.alb_tg_2_name
  target_aws_private_instance_2_id = module.private_ec2_2.aws_private_ec2
}
